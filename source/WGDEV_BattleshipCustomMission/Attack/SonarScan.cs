/*
Class Description:
This class used to initalize a standard Sonar scan from the classic game of Sea battle.
    ...
    class SonarScan : Attack
    {
        public SonarScan()
            : base(-1, new int[][][] { new int[][] { 
                ...
                new int[] { -1, 1 }, new int[] { 0, 1 }, new int[] { 1, 1 }
            }}, new bool[] { true }, AttackType.WeakScan, "Sonar Scan")
        {
        }
    }
}
